...
map.getView().fit([13236206.161392, -527018.373196, 13244679.736585, -521657.046222], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Distribusi Terumbu Karang ( Pulau Kapoposang ) - Sulawesi </h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (121 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'Peta ini merupakan distribusi terumbu karang di pulau kapoposang, sulawesi - Indonesia. Data ini berasal alen coral atlas';
            }
